1. 数据库主从分离配置
   ...
   spring.shardingsphere.datasource.master.read-only=false
   ...
   spring.shardingsphere.datasource.slave0.read-only=true
   ...
   spring.shardingsphere.datasource.slave1.read-only=true
